import { Spinner, Input, FormControl, useToast, FormLabel, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, useDisclosure, Text, Flex } from "@chakra-ui/react";
...
const SigninFormMain = () => {
    ...
    return (
        <>
            <Button onClick = {onOpen} colorScheme = "teal" variant = "outline">Signin</Button>
